...
public class FoodTagResource {
    ...
    @Timed
    public ResponseEntity<FoodTagDTO> createFoodTag(@RequestBody FoodTagDTO foodTagDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<FoodTagDTO> updateFoodTag(@RequestBody FoodTagDTO foodTagDTO) throws URISyntaxException {
