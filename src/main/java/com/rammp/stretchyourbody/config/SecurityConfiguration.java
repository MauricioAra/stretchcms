package com.rammp.stretchyourbody.config;

import com.rammp.stretchyourbody.security.*;
import com.rammp.stretchyourbody.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/noAuthResource/**").permitAll()
            .antMatchers("/api/register-user-health/**").permitAll()
